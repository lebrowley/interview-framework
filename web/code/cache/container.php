...
class CompiledContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            'Example\\Controller\\AddController' => 'getAddControllerService',
    ...
    /**
     * Gets the public 'Example\Controller\AddController' autowired service.
     *
     * @return \Example\Controller\AddController
     */
    protected function getAddControllerService()
    {
        return new \Example\Controller\AddController();
    }
    ...
    {
        return new \Example\Controller\ExampleController(new \Example\Model\ExampleModel(), new \Example\View\ExampleView());
    }
    ...
    {
        return new \Example\View\ExampleView();
    }
